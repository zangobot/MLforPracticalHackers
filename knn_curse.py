...
This is just a simple tutorial on k-NN algorithm on a higher dimensions.
SPOILER: stranger things gonna happen...
"""
import numpy as np
import sklearn
...
#Create dataset with higher number of dimensions
X, Y = make_blobs(n_samples = samples,n_features=n_features,centers=2,cluster_std=1.5)
print(X.shape)
...
#Plot everything!
plt.title('kNN - Error for range of K on higher dimensions')
